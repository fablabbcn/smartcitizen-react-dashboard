...
class KitSensors extends Component{
  ...
  render(){
    return(
      <div className={"p-3 col-6 col-md-4 col-xl-3 d-flex justify-content-between flex-column"} style={ this.getBgColor(this.props.data['id'], this.props.data['value']) }  >
        <div className="text-center my-3">
          <i className={ this.getFAIcon(this.props.data['id'], this.props.data['value']) }></i>
          <p className="">{Math.round(this.props.data['value'] * 100)/100} {this.props.data['unit']}</p>
        </div>
      </div>
    )
  }
